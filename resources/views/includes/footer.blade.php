        ...
        <div class="row g-5">
            <div class="col-lg-6 pe-lg-5">
                <a href="/" class="navbar-brand">
                    <img src="assets/img/logo.jpg" alt="Mining Company Logo"    style="width: 120px;">
                    <br>
                    <br>
                </a>
                ...
                <div class="d-flex justify-content-start mt-4">
                    ...
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-0 me-2" href="https://youtube.com/freewebsitecode/"><i class="fab fa-youtube"></i></a>
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-0" href="whatsapp://send?phone=+233205015724"><i class="fab fa-whatsapp"></i></a>
                </div>
            </div>
                ...
                <div class="row g-5">  
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white-50 mb-2" href="/services"><i class="fa fa-angle-right me-2"></i>Our Services</a>
                            <a class="text-white-50 mb-2" href="/"><i class="fa fa-angle-right me-2"></i>Meet The Team</a>
